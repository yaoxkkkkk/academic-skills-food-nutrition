...
| A literature question, no manuscript planned | `food-research` or `deep-research` standalone (skip the write path) |
...
| Open-ended, source-validated deep dive or a standalone literature-review article | `deep-research` |
...
- Literature/systematic review → `food-research` (systematic) or `deep-research`.
